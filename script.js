...
btn1.addEventListener('click', function () {
  ...
  if (!firstname.value || !lastname.value ||  !dob.value || !email1.value || !ph_code.value || !ph_no.value) {
  ...
  <div class="row g-0">
    ...
    <div class="col-7">
      <div class="card-body">
        ...
        <p class="card-text">${dob.value}</p>
        <p class="card-text">${ph_code.value} ${ph_no.value}</p>
        <p class="card-text">${op1.checked ? op1.value : op2.checked ? op2.value : op3.checked ? op3.value : 'Others'}</p>
    ...
    alert('Details Enrolled Successfully....!')
    form.reset()
  }
